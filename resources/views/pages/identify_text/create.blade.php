...
@section('breadcrumbs')
    <h1>
        ...
        Create identify text quiz for book: {{ $book->name }}
    </h1>
...
@section('content')
    <div class="box">
        <div class="box-body">
            <form class="store-identify-text" action="{{ route('admin.identifyText.store', [ 'id' => $book->id ]) }}"
                  method="post">
                {{ csrf_field() }}
                ...
                <div class="row col-xs-12">
                    ...
                    <div class="col-xs-12">
                        ...
                        <textarea class="form-control" type="text"
                                  value="{{ old('incorrect') }}"
                                  placeholder="Enter incorrect text" name="correct"></textarea>
                    </div>
                    <hr class="col-xs-12">
                    <div class="col-xs-4">
