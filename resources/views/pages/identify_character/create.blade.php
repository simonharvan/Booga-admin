...
@section('breadcrumbs')
    <h1>
        ...
        Create identify character quiz for book: {{ $book->name }}
    </h1>
    ...
    <div class="box">
        <div class="box-body">
            <form class="store-identify-character-quiz"
                  action="{{ route('admin.identifyCharacter.store', [ 'id' => $book->id ]) }}"
                  method="post">
                {{ csrf_field() }}
                ...
                <div class="row col-xs-12 answers-box">
                    <div class="answers-area">
                        ...
                        <div class="answer" id="answer-2">
                            <div class="col-xs-6 answer-2 margin-bottom">
                                <label class="answer-label">Answer 2</label>
                                <div class="col-xs-12 no-padding">
                                    <div class="col-xs-10 no-padding">
                                        <input class="form-control" type="text" placeholder="Enter answer"
                                               name="answer"
                                ...
                                <div class="col-xs-12 no-padding">
                                    ...
                                    <div class="col-xs-3 col-xs-offset-1 no-padding">
                                        <span href="#" data-toggle="tooltip"
                                            ...
                                            <label class="answer-label">Time to display <i class="fa fa-question-circle"></i> </label></span>
