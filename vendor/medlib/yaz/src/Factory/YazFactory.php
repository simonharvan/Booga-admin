...
use Medlib\Yaz\Query\QueryFromUrl;
...
abstract class YazFactory
{
	...
	public function fromUrl($url, $port, $database, $options = []) {
        $this->_parts['from'] = 'fromUrl';
        return new QueryFromUrl($url, $port, $database, $options, $this->_parts);
	}
