...
class ConnexionManager {
     ...
     * @return resource
     */
    public static function connection(AbstractConnexionManager $manager, $dsn, $options, $name)
    {
     ...
     */
	private function openConnection(AbstractConnexionManager $manager, $dsn, $options, $name)
    {
