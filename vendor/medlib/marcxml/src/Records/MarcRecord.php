...
class MarcRecord extends Record
{
    /**
     * @param string $x1
     * @param string $x2
...
//                    break;
                ...
                case 101:
                    $language = $this->parseExchangeChars($node->text('marc:subfield[@code="a"]'));
                ...
                case 210:
                    ...
                    $this->publisher = trim($this->parseExchangeChars($node->text('marc:subfield[@code="c"]')), ':');
                    $y = preg_replace('/^.*?([0-9]{4}).*$/', '\1', $node->first('marc:subfield[@code="d"]'));
                ...
                case 655:
                    ...
                    break;
                case 700:
                    $author = [ 'name' => Encoding::fixUTF8($node->text('marc:subfield[@code="b"]')),  'surname' => Encoding::fixUTF8($node->text('marc:subfield[@code="a"]'))];
